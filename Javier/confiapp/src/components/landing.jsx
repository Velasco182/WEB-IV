  ...
  * License: https://bootstrapmade.com/license/
  ...
  <section id="hero" className="d-flex justify-content-center align-items-center">
    <div className="container position-relative" data-aos="zoom-in" data-aos-delay={100}>
      ...
      <img src="Images/celruta.jpg" id="derecha" />
  ...
  <main id="main">
      ...
      <div className="container" data-aos="fade-up">
        <div className="row">
          <div className="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay={100}>
            <img src="Images/alerta.jpg" className="img-fluid" alt />
          </div>
    ...
    <section id="about" className="about">
      <div className="container" data-aos="fade-up">
        <div className="row">
          <div className="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay={100}>
            <img src="Images/segura.jpg" className="img-fluid" alt />
          </div>
    ...
    <section id="why-us" className="why-us">
      <div className="container" data-aos="fade-up">
        <div className="row" id="centradito">
          ...
          <img src="Images/otrafamilia.jpg" id="imagenn" />
          <p>
        ...
        <div className="row" data-aos="zoom-in" data-aos-delay={100}>
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div className="member">
              <img src="Images/padre.jpg" className="img-fluid" alt />
          ...
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div className="member">
              <img src="Images/juntos.jpg" className="img-fluid" alt />
              <div className="member-content">
          ...
          <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div className="member">
              <img src="Images/madre.jpg" className="img-fluid" alt />
              <div className="member-content">
                <h4>Ángela Sofía</h4>
  ...
  <div id="preloader">
    <img src="assets/images/Iconoverdetxt.png" alt />
  </div>
